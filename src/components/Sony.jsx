                ...
                <div className="card grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-20">
                    {
                        sonys.map(sony => (
                            ...
                            <div key={sony.Id} className="card w-full lg:w-96 bg-base-200 shadow-2xl mx-auto lg:mx-0">
                                {/* <Link to={`${sony.name}`}> */}
                                <img src={sony.Image} alt="" className="rounded-xl w-[300px] h-[200px] mx-auto mt-10" />
                                <div className="card-body items-center text-center">
                                    <h2 className="card-title text-black text-md font-medium">{sony.Name}</h2>
                                    <h2>Price: {sony.Price}</h2>
                                    <h2>Rating: {sony.Rating}/5</h2>
                                </div>
                                <div className="flex justify-center gap-3 pb-5">
                                    <Link to='/{sony.Details}'><button className="btn btn-outline">Details</button></Link>
                                    <Link to='/{sony.Update}'><button className="btn btn-outline">Update</button></Link>
                                </div>
                                {/* </Link> */}
                            </div>
