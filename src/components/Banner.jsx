...
const Banner = () => {
    ...
    return (
        <>
            <div className="carousel w-full bg-white dark:bg-black">
                <div id="slide1" className="carousel-item relative w-full">
                    <img src={img1} alt="" className="w-full opacity-50" />
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide4" className="btn btn-circle">❮</a>
                        <p className="text-center text-red-600 dark:text-sky-500 sm:text-5xl md:text-5xl font-bold">Discover Tomorrow's Tech Today <br />
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        ...
                        <p className="text-center text-orange-400 text-5xl font-bold">Discover Tomorrow's Tech Today <br />
                            Explore the Latest Gadgets and Electronics from <br /> Top Brands</p>
